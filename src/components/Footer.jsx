      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-3">
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">
              Connecting communities to professional healthcare support through accessible, localized AI guidance.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs font-semibold text-slate-600 dark:text-slate-300">
              <li>
                <button onClick={() => setActivePage('chat')} className="hover:text-sky-500 cursor-pointer">
                  AI Symptom Assessment
                </button>
              </li>
              <li>
                <button onClick={() => setActivePage('clinics')} className="hover:text-sky-500 cursor-pointer">
                  Clinics & Hospital Directory
                </button>
              </li>
              <li>
                <button onClick={() => setActivePage('reminders')} className="hover:text-sky-500 cursor-pointer">
                  Medication Tracking
                </button>
              </li>
              <li>
                <button onClick={() => setActivePage('education')} className="hover:text-sky-500 cursor-pointer">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed mb-2">
              Ready for production integration with local WhatsApp, SMS, and Voice response networks.
            </p>
        ...
        <div className="mt-8 pt-6 border-t border-slate-200 dark:border-slate-800 flex flex-col sm:flex-row items-center justify-between">
          ...
          <p className="text-xs text-slate-400 dark:text-slate-500 mt-2 sm:mt-0 flex items-center">
            Designed for impact with <Heart className="h-3.5 w-3.5 mx-1 text-red-500 animate-pulse fill-current" /> in West Africa.
          </p>
        </div>
